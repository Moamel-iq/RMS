...
MODULES: tuple[Module, ...] = (
    ...
    Module(
        ...
        sections=(
            ...
            Section(label=_("الورديات")),
            Section(label=_("الحضور والانصراف")),
            Section(label=_("الإجازات والغياب")),
            Section(label=_("العمل الإضافي")),
            Section(label=_("الاستقطاعات")),
            Section(label=_("السلف")),
            Section(label=_("احتساب الرواتب")),
            Section(label=_("اعتماد الرواتب")),
