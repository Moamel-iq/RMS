...
MODELS = ("UnitOfMeasure", "HistoricalUnitOfMeasure")


def rename_legacy_name_columns(apps, schema_editor):
    for model_name in MODELS:
        model = apps.get_model("units", model_name)
...
class Migration(migrations.Migration):
    dependencies = [("units", "0002_historicalunitofmeasure")]
    operations = [
        migrations.SeparateDatabaseAndState(
            ...
            state_operations=[
                ...
                for model_name in ("unitofmeasure", "historicalunitofmeasure")
            ],
        )
    ]
