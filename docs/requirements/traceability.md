...
| PRC-043 | Price variance never restates a posted movement or a closed period | posting service | Task 2.11 computes and stores the figure without posting it: `apps/procurement/tests/test_matching.py::test_a_dearer_invoice_gives_a_positive_variance`, `apps/procurement/tests/test_matching.py::test_the_variance_is_its_own_arithmetic_at_the_database`, `apps/procurement/tests/test_matching.py::test_a_ready_match_posts_no_journal` | 2.12 | Task 2.11 stores the figure; Task 2.12 posts it | Partial |
