...
| PRC-049 | The average-versus-credit difference is a purchase return variance | ADR-022 §2 **as amended**: recognised at the credit note, never at the return; the return posts clearing/inventory only | `apps/procurement/tests/test_supplier_returns.py::test_it_posts_no_return_variance`, `apps/procurement/tests/test_supplier_returns.py::test_the_expected_credit_is_metadata_and_posts_nothing`, `apps/procurement/tests/test_supplier_returns.py::test_the_return_variance_role_is_seeded_and_unmapped` | 2.13, 2.14 | The 2.13 half — the account exists, the return refuses to touch it — is done and held by negatives; the recognising entry is 2.14's credit note. | Partial |
