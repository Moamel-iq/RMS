...
Task 2.5 16 with Task 2.6 and 17 with Task 2.7;
18–19 are written and called but cannot be tripped until goods receipts
exist in Task 2.8. The rest are still statements of intent, and the
